...
function Customer({data,index}) {
  ...
  return (
    <div className=' col-3 '>
        ...
        <div className={index === 0 ?'activesinglefeedback':'singlefeedback'}>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
        </div>

        <div className='customerimageandfeedback'>
            {/* <div className='customerimagediv'> */}
            <div className={index === 0 ?'activecustomerimagediv':'customerimagediv'}>
                {/* <img src /> */}
                <BsFileImage/>
            </div>
            <div className='dateandname'>
                <div className={index === 0 ?'activecustomername':'customername'} >
                   {data.name}
                </div>
